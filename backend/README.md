...
## Project Structure
    ...
    ├── ideapros_llc_squad__32426  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_squad__32426`
...
2. Clone this repo and `cd ideapros_llc_squad__32426`
